...
const CollectionObjectsDataGrid: React.FC = () => {
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'coordinates', headerName: 'Coordinates', width: 100, renderCell: (params) => {
                return `(${params.value.x}, ${params.value.y})`
            }},
        { field: 'creationDate', headerName: 'Creation Date', width: 120, renderCell: (params) => {
        ...
        { field: 'bestAlbum', headerName: 'Best album', width: 120, renderCell: (params) => {
                return params.value !== null ? params.value.name : null
            }},
        { field: 'albumsCount', headerName: 'Albums', width: 95},

        { field: 'studio', headerName: 'Studio', width: 80, renderCell: (params) => {
                return params.value !== null ? params.value.name : null
            }},
        { field: 'studioAddress', headerName: 'Studio Address', width: 130, renderCell: (params) => {
            const studio = params.row.studio;
            if (!studio || !studio.address) return null;
